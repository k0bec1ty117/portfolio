...
#モデルの準備
file_path = 'intel/pedestrian-and-vehicle-detector-adas-0001/FP32/pedestrian-and-vehicle-detector-adas-0001'
model= file_path + '.xml'
...
# 入力データフォーマットへ変換 
img = cv2.resize(frame, (672, 384)) # サイズ変更 
...
for detection in out:
    ...
    # バウンディングボックスの色を指定
    colors = {1:(220,20,60), 2:(35,59,108)}
